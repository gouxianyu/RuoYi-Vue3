    ...
    <div class="app-container">
        ...
        <el-table v-loading="loading" :data="skillList" @selection-change="handleSelectionChange">
            ...
            <el-table-column label="操作" align="center" width="160" class-name="small-padding fixed-width">
                <template #default="scope">
                    <el-button link type="primary" icon="Edit" @click="handleBind(scope.row)"
        ...
        <el-dialog :title="title" v-model="open" width="500px" append-to-body>
            <el-form ref="sceneRef" :model="form" :rules="rules" label-width="80px">
                <el-form-item label="场景编号" prop="sceneName">
                    <el-input v-model="form.sceneName" placeholder="请输入场景编号" />
                </el-form-item>
